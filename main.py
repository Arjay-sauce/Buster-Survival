...
class Monster(pygame.sprite.Sprite):
    ...
    def update(self):
        for character in Bustesurvival.player:
...
class Bustesurvival:
    ...
    def load(self):
        ...
        try:
            pygame.mixer.music.load("bg.mp3")  # Replace with your music file name
    ...
    def load_window(self):
        ...
        pygame.display.set_caption("Buster survival")
...
'WWTTTTTWWWWWWWWWWWWWWWWWWWWWWWWWWTTTTTWW',]
    ...
    def draw_info_screen(self):
        ...
        if self.current_level == 0:
            ...
            map_cleared_text = self.font.render(f"You completed level UP {self.current_level - 1}!", True, (255, 0, 0) )
            text_rect = map_cleared_text.get_rect(center=(self.WIDTH/2, self.HEIGHT/5))
            self.window.blit(map_cleared_text, (text_rect) )
